...
public class PayInfo {
    ...
    public PayInfo(Integer id, Integer userId, Long orderNo, Integer playPlatform, String platformNumber, String platformStatus, Date createTime, Date updateTime) {
        this.id = id;
        this.userId = userId;
